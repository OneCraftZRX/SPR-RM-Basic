...
class Ui_ImageMiniLabUI(object):
    def setupUi(self, ImageMiniLabUI):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=ImageMiniLabUI)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayout = QtWidgets.QGridLayout(self.centralwidget)
        self.gridLayout.setObjectName("gridLayout")
        self.LabCtrlWidget = QtWidgets.QWidget(parent=self.centralwidget)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.LabCtrlWidget)
        self.label_2.setMinimumSize(QtCore.QSize(80, 0))
        self.label_2.setMaximumSize(QtCore.QSize(80, 16777215))
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_2.addWidget(self.label_2)
        self.ExpTypeComboBox = QtWidgets.QComboBox(parent=self.LabCtrlWidget)
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.LabCtrlWidget)
        self.label_3.setMinimumSize(QtCore.QSize(80, 0))
        self.label_3.setMaximumSize(QtCore.QSize(80, 16777215))
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_3.addWidget(self.label_3)
        self.ExpImgLineEdit = QtWidgets.QLineEdit(parent=self.LabCtrlWidget)
        ...
        self.SelectImgPushButton = QtWidgets.QPushButton(parent=self.LabCtrlWidget)
        ...
        self.label = QtWidgets.QLabel(parent=self.LabCtrlWidget)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.stackedWidget = QtWidgets.QStackedWidget(parent=self.LabCtrlWidget)
        ...
        self.LoadTestDataPushButton = QtWidgets.QPushButton(parent=self.LabCtrlWidget)
        ...
        self.GoExpPushButton = QtWidgets.QPushButton(parent=self.LabCtrlWidget)
        ...
        self.ImgShowWidget = QtWidgets.QWidget(parent=self.centralwidget)
        self.ImgShowWidget.setObjectName("ImgShowWidget")
        self.SrcImgShowLabel = QtWidgets.QLabel(parent=self.ImgShowWidget)
        self.SrcImgShowLabel.setGeometry(QtCore.QRect(35, 11, 120, 16))
        self.SrcImgShowLabel.setObjectName("SrcImgShowLabel")
        self.DstImgShowLabel = QtWidgets.QLabel(parent=self.ImgShowWidget)
        ...
        self.menubar = QtWidgets.QMenuBar(parent=ImageMiniLabUI)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1333, 22))
        self.menubar.setObjectName("menubar")
        ImageMiniLabUI.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=ImageMiniLabUI)
